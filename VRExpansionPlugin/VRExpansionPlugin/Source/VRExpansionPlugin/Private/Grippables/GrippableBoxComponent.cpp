	...
	bRepGripSettingsAndGameplayTags(true             )
{
  ...
  //bRepGripSettingsAndGameplayTags = true;   Moved to direct initialization.
}
...
void UGrippableBoxComponent::ClosestGripSlotInRange_Implementation
(
...
bool UGrippableBoxComponent::RequestsSocketing_Implementation(USceneComponent*& ParentToSocketTo, FName& OptionalSocketName, FTransform_NetQuantize& RelativeTransform) 
{ 
	return false; 
}
...
void UGrippableBoxComponent::GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifetimeProps) const
{
    ...
    /*_CONDITION*/
	DOREPLIFETIME(UGrippableBoxComponent, GripLogicScripts               );   // , COND_Custom);
