...
public:
	...
	*/
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionFunctions", meta = (DisplayName = "Equal VR Grip", CompactNodeTitle = "==", Keywords = "== equal"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "VRExpansionLibrary", meta = (DisplayName = "Add Scene Component By Class"))
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary", meta = (DisplayName = "ToGripID (FBPGripPair)", CompactNodeTitle = "->", BlueprintAutocast))
		static uint8 Conv_GripPairToGripID(const FBPGripPair& GripPair);

	/** Converts a FBPGripPair into a MotionController. */
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary", meta = (DisplayName = "ToController (FBPGripPair)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintCallable, Category = "VRExpansionLibrary", meta = (DisplayName = "Smooth Update Laser Spline"))
		static void SmoothUpdateLaserSpline
		(
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary|TransformNetQuantize", meta = (DisplayName = "ToTransform_NetQuantize (Transform)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary|FVectorNetQuantize", meta = (DisplayName = "ToVector_NetQuantize (Vector)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary|FVectorNetQuantize", meta = (DisplayName = "ToVector_NetQuantize10 (Vector)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary|FVectorNetQuantize", meta = (DisplayName = "ToVector_NetQuantize100 (Vector)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintPure, Category = "VRExpansionLibrary|TransformNetQuantize", meta = (Scale = "1,1,1", Keywords = "construct build", NativeMakeFunc))
